...
gh run list --repo LocalSME/LocalSME.github.io --limit 3
```
...
| Repository access | **Only select repositories → `LocalSME.github.io`** |
...
Then open <https://localsme.github.io/admin/>, choose **"Sign In Using Access
Token"** and paste it.
...
3. Install the app at <https://github.com/apps/giscus> and grant it access to
   `LocalSME/LocalSME.github.io` **only**.
4. Go to <https://giscus.app>, enter `LocalSME/LocalSME.github.io`, pick the category, and choose
...
```ts
export const GISCUS = {
  repo: 'LocalSME/LocalSME.github.io',
  repoId: 'R_kg...',        // ← paste
